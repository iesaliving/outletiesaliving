                          ...
                          <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                   ...
                                   <input id="Email_de_Dealer" name="Email_de_Dealer" type="text" class="form-control @error('Email_de_Dealer') is-invalid @enderror" value="{{ old('Email_de_Dealer', isset($data) ? $data->Email_de_Dealer : '') }}" maxlength="100" required="">
    ...
    <div class="modal-content px-2" style="border-radius: 20px;padding-top: 0;">
      ...
      <div class="modal-body">
        <div class="bottommargin text-center">
            <p class="nomargin"> Si desea Enviar Precotización a Prospecto y contactarlo con Distribuidor, presione "OK". En caso de que desee modificar algo presione "REGRESAR".</p>
        </div>
