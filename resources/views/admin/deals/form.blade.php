                      ...
                      <div class="col-12">
                       ...
                       <form class="form-horizontal" role="form" method="POST" action="{{ isset($data) ? route('admin.deals.update') : route('admin.deals.store') }}"  enctype="multipart/form-data">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-1 px-0" >
                                  <a class="btn  mx-1 btn-info fa fa-plus" href=""></a>
                                </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select required id="marca" name="marca[]" class="form-control @error('marca') is-invalid @enderror" required>
                                      <option value="">Seleccione Marca</option>
                                      @foreach ($marcas as $marca)

                                        <option 
                                          @if (isset($data))
                                            @if ($data->marca[0] == $marca['displayValue'])
                                              selected="selected" 
                                            @endif
                                          @endif
                                          @if (old('marca') ==  $marca['displayValue']) 
                                            selected="selected" 
                                          @endif 

                                          value="{{$marca['displayValue']}}">{{$marca['displayValue']}}
                                        </option>
                                      @endforeach
                                    </select>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                                <label for="dealer_name" class="col-md-12 col-form-label text-md-left">Nombre de vendedor de dealer</label>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                                <label for="Representante" class="col-md-12 col-form-label text-md-left">Representante</label>

                                <div class="col-md-12">

                                    <select required id="Representante" name="Representante" class="form-control @error('Representante') is-invalid @enderror" required>
                                     @foreach ($representantes as $representante)

                                        <option 
                                          @if (isset($data))
                                            @if ($data->Representante == $representante['displayValue'])
                                              selected="selected" 
                                            @endif
                                          @endif
                                          @if (old('Representante') ==  $representante['displayValue']) 
                                            selected="selected" 
                                          @endif 

                                          value="{{$representante['displayValue']}}">{{$representante['displayValue']}}
                                        </option>
                                      @endforeach
                          ...
                          <div class="col-md-6 offset-md-6">
                            <div class="form-group row">
                                <label for="Representante_email" class="col-md-12 col-form-label text-md-left">Representante email</label>

                                <div class="col-md-12">


                                    <input required id="Representante_email" name="Representante_email" type="email" class="form-control @error('Representante_email') is-invalid @enderror" value="{{ old('Representante_email', isset($data) ? $data->Representante_email : '') }}" maxlength="100" required="">
