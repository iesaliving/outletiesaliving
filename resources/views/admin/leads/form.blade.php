                                ...
                                <div class="col-md-12">
                                    ...
                                    <select required id="marca" name="marca[]" class="form-control @error('marca') is-invalid @enderror" required>
                                      ...
                                      @foreach ($marcas as $marca)
                                        ...
                                        <option 
                                          @if (isset($data))
                                            @if ($data->marca[0] == $marca['actualValue'])
                                              selected="selected" 
                                            @endif
                                          @endif
                                          @if (old('marca') ==  $marca['actualValue']) 
                                            selected="selected" 
                                          @endif 

                                          value="{{$marca['actualValue']}}">{{$marca['displayValue']}}
                                        </option>
                                      @endforeach
                                    </select>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select required id="Estatus" name="Estatus" class="form-control @error('Estatus') is-invalid @enderror" required>
                                      @foreach ($estatus as $estatu)
                                        <option 
                                          @if (isset($data))
                                              @if ($data->estatu == $estatu['actualValue'])
                                                selected="selected" 
                                              @endif
                                            @endif
                                            @if (old('estatu') ==  $estatu['actualValue']) 
                                              selected="selected" 
                                            @endif 
                                        value="{{$estatu['actualValue']}}">
                                          {{$estatu['displayValue']}}
                                      </option>
                                      @endforeach
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select required id="Lead_Source" name="Lead_Source" class="form-control @error('Lead_Source') is-invalid @enderror" required>
                                      @foreach ($LeadSources as $LeadSource)
                                        <option 
                                        @if (isset($data))
                                              @if ($data->Lead_Source == $LeadSource['actualValue'])
                                                selected="selected" 
                                              @endif
                                            @endif
                                            @if (old('LeadSource') ==  $LeadSource['actualValue']) 
                                              selected="selected" 
                                            @endif 
                                        value="{{$LeadSource['actualValue']}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input required id="Representante" name="Representante" type="text" class="form-control @error('Representante') is-invalid @enderror" value="{{ old('Representante', isset($data) ? $data->Representante : '') }}" maxlength="100" required="">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                                <label for="Dealer" class="col-md-12 col-form-label text-md-left">Nombre de Dealer</label>
