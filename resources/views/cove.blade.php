        ...
        <div id="container-catalogo" class="margin-10">
            ...
            <div class="row col-padding catalogo topmargin-lg">
                <div class="col-lg-6 col-padding-sm">
                    <img src="{{ asset('img/cove/vajilla.jpg')}}">
                </div>
        ...
        <div class="margin-10 row">
            ...
            <div class="bottommargin-sm col-md-4">
                <div class="col-5 nopadding">
                    <img src="{{ asset('img/cove/limpie.png')   }}">
                </div>
            ...
            <div class="bottommargin-sm col-md-4">
                <div class="col-5 nopadding">
                    <img src="{{ asset('img/cove/personalice.png')   }}">
                </div>
                <div class="col-12 nopadding topmargin-sm">
            ...
            <div class="bottommargin-sm col-md-4">
                <div class="col-5 nopadding">
                    <img src="{{ asset('img/cove/silencio.png')   }}">
                </div>
                <div class="col-12 nopadding topmargin-sm">
            ...
            <div class="bottommargin-sm col-md-4 offset-md-1">
                <div class="col-5 nopadding">
                    <img src="{{ asset('img/cove/ajuste.png')   }}">
                </div>
                <div class="col-12 nopadding topmargin-sm">
            ...
            <div class="bottommargin-sm col-md-4 offset-md-2">
                <div class="col-5 nopadding">
                    <img src="{{ asset('img/cove/asegura.png')   }}">
                </div>
                <div class="col-12 nopadding topmargin-sm">
...
<section class="container-fb" style="background-image: url('{{ asset('img/cove/facebook.jpg')}}')">
