        ...
        <div id="container-faq" class="margin-10">
            ...
            <div class="topmargin">
                ...
                <ol>
                    ...
                    <li style="color: #01bb9c"><p style="color:#000;"><b>IESA</b> no asume la responsabilidad del uso o falta de uso de sus descargas, hardware, software o problemas con la configuración del sistema. El uso de las descargas queda bajo responsabilidad y discreción del usuario. <b>IESA</b> no asume responsabilidades sobre el software o la información, en particular con respecto a cubrir un propósito específico, la validez de sus contenidos o la ausencia de virus.</p></li>
                    ...
                    <li style="color: #01bb9c"><p style="color:#000"><b>IESA</b> no se hace responsable por errores en la transmisión de datos a <b>IESA</b>, la manipulación de dichos datos por terceros no autorizados en particular mediante el acceso a la red y a los sistemas de <b>IESA</b>.</p></li>
