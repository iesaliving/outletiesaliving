<div class="container-hero-image" style="background-image: url('{{ URL::asset('img/dexa/hero.jpg')}}');">
    <div class="col-12 nopadding h-100 d-flex aling">
        <div class="justify-content-center align-self-center col-md-5 gradient-hero-cove">
            <img style="width: 200px;margin-left: -65px;margin-bottom: 10px" src="{{ URL::asset('img/dexa/logo.png')}}">
            <h2 class="light h2-text">DEXA NON E</h2>
