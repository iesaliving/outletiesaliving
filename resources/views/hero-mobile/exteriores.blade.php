    ...
    <div class="col-11 offset-1 col-padding d-flex {{(request()->segment('1')==null)?'m-height':''}}">
        <div class="justify-content-center align-self-center">
            <div class="col-12 nopadding" style="display: inherit; margin-bottom: 10px">
                    <a href="{{ URL::to('/sub-zero') }}"><img id="img-SubZero" style="" src="{{ asset('img/cintillos/SubZero.png')}}"></a>

                    <a href="{{ URL::to('/wolf') }}"><img id="img-wolf" style="" src="{{ asset('img/cintillos/Wolf.png')}}"></a>
            </div> 
