...
class DealsController extends Controller
{
   ...
   /*     $moduleIns = ZCRMRestClient::getInstance()->getModuleInstance("Deals"); // To get module instance
        $criteria="Representante_email:equals:fmartinez@iesa.cc";//criteria to search for
...
*/
    ...
    public function create(){
        ...
        $representantes=$this->fields('4434756000000625372','Deals');//id Fiels Obtenidos de $this->campos()
        ...
        return view('admin.deals.form', compact('contacts','accounts','marcas', 'ubicaciones' , 'stages' , 'representantes','dealers'));
    }
    ...
    public function edit(Request $request){
        ...
        return view('admin.deals.form', compact('contacts','accounts','marcas', 'ubicaciones' , 'stages' , 'representantes','dealers','data'));
