...
class LeadsController extends Controller
{
    ...
    public function create(){
        ...
        return view('admin.leads.form', compact('marcas', 'ubicaciones' , 'estatus' , 'LeadSources','dealers'));
    }
       ...
       // $duplicate_check_fields=array('Company');
        ...
        if($zohoRespuesta[0]->getStatus()!='success'){
           abort(404);
            ...
            $var->setBrand($request->input('marca')[0]);
            $response=$var->upsert();
    ...
    public function edit(Request $request){
        ...
        return view('admin.leads.form', compact('marcas', 'ubicaciones' , 'estatus' , 'LeadSources','dealers','data'));
    ...
    private function validarLead($leadsId){
        ...
        $moduleIns = ZCRMRestClient::getInstance()->getModuleInstance("Leads"); // To get module instance
         $param_map = array("fields"=>"First_Name,Last_Name,Phone,Email,Marca,Producto,Estado,Lead_Status,Nombre_de_Arquitecto,Phone_Arquitecto,Email_Arquitecto,Lead_Source,Representante,Dealer,Nombre_de_vendedor_de_dealer,Description"); // key-value pair containing all the
